...
class ActivityNetDataset(Dataset):
    def __init__(
        ...
        self.db_attributes = {
            ...
            'tiou_thresholds': [0.5, 0.75, 0.95],#np.linspace(0.5, 0.95, 10),
            'empty_label_ids': []
        }
    ...
    def __getitem__(self, idx):
        ...
        # cut feats and feats_audio to the same length, their minimum
        min_len = min(feats.shape[1], feats_audio.shape[1])
        feats = feats[:, :min_len]
